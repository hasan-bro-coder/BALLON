...
/** @type {string} */
const CACHE_VERSION = '1746957699|3342737353';
/** @type {string} */
const CACHE_PREFIX = 'BALLON-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'BALLON.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["BALLON.html","BALLON.js","BALLON.offline.html","BALLON.icon.png","BALLON.apple-touch-icon.png","BALLON.audio.worklet.js","BALLON.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["BALLON.wasm","BALLON.pck"];
